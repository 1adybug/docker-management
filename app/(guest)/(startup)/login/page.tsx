...
const Page: FC = () => {
    ...
    useEffect(() => {
        ...
        message.open({
            key: messageKey,
            type: "error",
            content: getOAuthLoginErrorMessage(providerId, error, description),
        })
        ...
        <PhoneLoginForm onLoginSuccess={() => router.refresh()}>
            {isGeshuOAuthVisible && (
                <Button
                    ...
                    loading={pendingProviderId === GeshuOAuthProviderId}
            ...
            {isGeshuAgentOAuthVisible && (
                <Button
                    className="mt-4"
                    block
                    loading={pendingProviderId === GeshuAgentOAuthProviderId}
