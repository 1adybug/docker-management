    ...
    return (
        <Card>
            ...
            <CardContent className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <div className="bg-muted text-muted-foreground flex size-12 flex-none items-center justify-center rounded-2xl">
                    {linked ? <ShieldCheckIcon className="text-primary size-6" /> : <LinkIcon className="size-6" />}
                </div>
